 ...
 public:
    ...
    */
    ...
    void test_make_matchRegex_int_keyword(void) {
      regex_t *re = fcal::scanner::make_regex("^(I|i)nt");
      TS_ASSERT(re);
    ...
    void test_make_matchRegex_float_keyword(void) {
      regex_t *re = fcal::scanner::make_regex("^(F|f)loat");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "float ");
      TS_ASSERT(numMatchedChars == 5);
    }

    // March 3: Added boolean regexes
    void test_make_matchRegex_bool_keyword(void) {
      regex_t *re = fcal::scanner::make_regex("^(bool)");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "bool ");
      TS_ASSERT(numMatchedChars == 4);
    }

    void test_make_matchRegex_true_keyword(void) {
      regex_t *re = fcal::scanner::make_regex("^(T|t)rue");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "true ");
      TS_ASSERT(numMatchedChars == 4);
    }

    void test_make_matchRegex_false_keyword(void) {
      regex_t *re = fcal::scanner::make_regex("^(F|f)alse");
      TS_ASSERT(re);
    ...
    void test_make_matchRegex_string_keyword(void) {
      regex_t *re = fcal::scanner::make_regex("^(S|s)tring");
      TS_ASSERT(re);
    ...
    void test_make_matchRegex_matrix_keyword(void) {
      regex_t *re = fcal::scanner::make_regex("^(M|m)atrix");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "matrix ");
      TS_ASSERT(numMatchedChars == 6);
    }

    void test_make_matchRegex_let_keyword(void) {
    ...
    void test_make_matchRegex_in_keyword(void) {
    ...
    void test_make_matchRegex_end_keyword(void) {
    ...
    void test_make_matchRegex_if_keyword(void) {
    ...
    void test_make_matchRegex_then_keyword(void) {
    ...
    void test_make_matchRegex_else_keyword(void) {
    ...
    void test_make_matchRegex_repeat_keyword(void) {
    ...
    // March 3: Added while regex
    void test_make_matchRegex_while_keyword(void) {
    ...
    void test_make_matchRegex_print_keyword(void) {
    ...
    void test_make_matchRegex_to_keyword(void) {
    ...
    // Regex for constants
    void test_make_matchRegex_int_const(void) {
      regex_t *re = fcal::scanner::make_regex("^[0-9]+");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "90");
      TS_ASSERT(numMatchedChars == 2);
    }

    void test_make_matchRegex_float_const(void) {
      regex_t *re = fcal::scanner::make_regex("^[0-9]*\\.[0-9]+");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "0.23");
      TS_ASSERT(numMatchedChars == 4);
    }

    void test_make_matchRegex_str_const(void) {
      regex_t *re = fcal::scanner::make_regex("^(\"([^\"]*)\")");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "\"\"");
      TS_ASSERT(numMatchedChars == 2);
    ...
    void test_make_matchRegex_variable_name(void) {
      regex_t *re = fcal::scanner::make_regex("^[a-zA-Z_]+[a-zA-Z0-9_-]*");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "_somename");
      TS_ASSERT(numMatchedChars == 9);
    }

    // Regex for punctuations
    void test_make_matchRegex_left_paren(void) {
      regex_t *re = fcal::scanner::make_regex("^(\\()");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "()");
      TS_ASSERT(numMatchedChars == 1);
    ...
    void test_make_matchRegex_right_paren(void) {
      regex_t *re = fcal::scanner::make_regex("^(\\))");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, ")(");
      TS_ASSERT(numMatchedChars == 1);
    ...
    void test_make_matchRegex_left_curly_bracket(void) {
      regex_t *re = fcal::scanner::make_regex("^(\\{)");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "{}");
      TS_ASSERT(numMatchedChars == 1);
    ...
    void test_make_matchRegex_right_curly_bracket(void) {
      regex_t *re = fcal::scanner::make_regex("^(\\})");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "}");
      TS_ASSERT(numMatchedChars == 1);
    ...
    void test_make_matchRegex_left_sq_bracket(void) {
      regex_t *re = fcal::scanner::make_regex("^(\\[)");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "[]");
      TS_ASSERT(numMatchedChars == 1);
    ...
    void test_make_matchRegex_right_sq_bracket(void) {
      regex_t *re = fcal::scanner::make_regex("^(\\])");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "]12");
      TS_ASSERT(numMatchedChars == 1);
    }

    // Regex for operators

    void test_make_matchRegex_assign_op(void) {
      regex_t *re = fcal::scanner::make_regex("^(=)");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "=");
      TS_ASSERT(numMatchedChars == 1);
    ...
    void test_make_matchRegex_plus(void) {
      regex_t *re = fcal::scanner::make_regex("^(\\+)");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "+ ");
      TS_ASSERT(numMatchedChars == 1);
    ...
    void test_make_matchRegex_asterisk(void) {
      regex_t *re = fcal::scanner::make_regex("^(\\*)");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "* ");
      TS_ASSERT(numMatchedChars == 1);
    ...
    void test_make_matchRegex_dash(void) {
      regex_t *re = fcal::scanner::make_regex("^(\\-)");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "-+");
      TS_ASSERT(numMatchedChars == 1);
    ...
    void test_make_matchRegex_forward_slash(void) {
      regex_t *re = fcal::scanner::make_regex("^(\\/)");
      TS_ASSERT(re);
    ...
    void test_make_matchRegex_less_than(void) {
      regex_t *re = fcal::scanner::make_regex("^(<)");
      TS_ASSERT(re);
    ...
    void test_make_matchRegex_less_than_equal(void) {
      regex_t *re = fcal::scanner::make_regex("^(<=)");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "<=");
      TS_ASSERT(numMatchedChars == 2);
    ...
    void test_make_matchRegex_greater_than(void) {
      regex_t *re = fcal::scanner::make_regex("^(>)");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, ">");
      TS_ASSERT(numMatchedChars == 1);
    ...
    void test_make_matchRegex_greater_than_equal(void) {
      regex_t *re = fcal::scanner::make_regex("^(>=)");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, ">=");
      TS_ASSERT(numMatchedChars == 2);
    ...
    void test_make_matchRegex_equal_equal(void) {
      regex_t *re = fcal::scanner::make_regex("^(==)");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "==");
      TS_ASSERT(numMatchedChars == 2);
    ...
    void test_make_matchRegex_not_equal(void) {
      regex_t *re = fcal::scanner::make_regex("^(!=)");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "!=");
      TS_ASSERT(numMatchedChars == 2);
    ...
    void test_make_matchRegex_and_op(void) {
      regex_t *re = fcal::scanner::make_regex("^(&&)");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "&&");
      TS_ASSERT(numMatchedChars == 2);
    ...
    void test_make_matchRegex_or_op(void) {
      regex_t *re = fcal::scanner::make_regex("^(\\|\\|)");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "||");
      TS_ASSERT(numMatchedChars == 2);
    ...
    void test_make_matchRegex_not_op(void) {
      regex_t *re = fcal::scanner::make_regex("^(!)");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "!");
      TS_ASSERT(numMatchedChars == 1);
    ...
    // Regex for lexical errors and EOF
    void test_make_matchRegex_lexical_error(void) {
      regex_t *re = fcal::scanner::make_regex("()");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "");
    ...
    void test_make_matchRegex_end_of_file(void) {
      regex_t *re = fcal::scanner::make_regex("(EOF)");
      TS_ASSERT(re);
      int numMatchedChars = fcal::scanner::match_regex(re, "EOF");
      TS_ASSERT(numMatchedChars == 3);
    }
    ...
    */
    ...
    void test_terminaL_endOfFile(void) {
      TS_ASSERT(s->end_token_tester("EOF", "EOF",
